		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$(document).on("click", ".replyDelBtn", function(){
					var index = $(".replyDelBtn").index(this);
					var necmt_num = $(".wrapper:eq("+index+")").attr("data-num");
					
					$.ajax({
						url: "/admin/necmt/replyDelete",
						type: "post",
						data: "necmt_num="+necmt_num,
						dataType: "text",
						success: function(){
							alert("댓글이 삭제되었습니다.");
							location.reload();
			...
			function addItem(necmt_num, c_nickname, necmt_content, necmt_date) {
				...
				delBtn.addClass("btn btn-default gap replyDelBtn");
				delBtn.html("삭제하기"); 
				...
				// 조립하기
				new_div.append(name_span).append(date_span).append(delBtn);
